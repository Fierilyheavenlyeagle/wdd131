...
function playGame(playerMove) {
  ...
  if 
  (playerMove ==='paper') {if (computerMove === 'rock')  
  {result= 'You win';} else if
  (computerMove === 'paper')
  {result = 'Tie.';}
  ...
  else if (result === 'You lose'){score.losses += 1}else if (result === 'Tie.'){score.ties += 1;}
